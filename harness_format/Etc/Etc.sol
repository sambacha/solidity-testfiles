...
contract Contract {
    struct StructWithFunctionTypes {
        ...
        function (uint, uint) returns(bool,bytes32, bytes32, bytes32, bytes32, bytes32, bytes32, bytes32)
            a;
        function(bytes32, bytes32)   internal view[] b;
        function  (bytes32, bytes32)internal[] c;
        function(bytes32, bytes32, bytes32, bytes32, bytes32, bytes32)   internal view[]
            d;
        function(bytes32, bytes32, bytes32, bytes32, bytes32, bytes32, bytes32, bytes32, bytes32)   internal view[]
            e;
    }

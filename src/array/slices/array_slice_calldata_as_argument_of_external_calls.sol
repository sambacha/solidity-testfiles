contract C {
    function f1(bytes calldata c1, uint256 s, uint256 e, bytes calldata c2)
        public
        returns (bool)
    {
    ...
    function f2(bytes calldata c, uint256 s)
        public
    ...
    function f3(bytes calldata c1, uint256 s, uint256 e, bytes calldata c2)
        public
        returns (bool)
    {
    ...
    function f4(bytes calldata c1, uint256 s, uint256 e, bytes calldata c2)
        public
        returns (bool)
    {
